...
|---|---|---|---|
| `Hash` | spin 1–8192 | 64 | transposition table, MB |
...
**30/30 GUI checks passed**, tactical regression suite **7/7 deterministic**
at depth 12, opening-book oracle test against python-chess passed
(176 entries, 250 probes).
