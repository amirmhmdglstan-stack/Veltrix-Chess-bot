...
class VeltrixApp:
    ...
    def _apply_engine_options(self, client: UCIClient):
        ...
        client.set_option("Threads", self.cfg.threads)
    ...
    def apply_cfg_visual(self):
        ...
        self.canvas.configure(width=self.cfg.board_size, height=self.cfg.board_size)
    ...
    def dialog_size(self):
        v = simpledialog.askinteger("Board size", "pixels (240-800):",
                                    initialvalue=self.cfg.board_size,
                                    minvalue=240, maxvalue=800, parent=self.root)
        if v:
