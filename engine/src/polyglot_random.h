// Veltrix 1.0 - Polyglot opening-book Zobrist random-number table
// Copyright (C) 2026 Veltrix Project
// SPDX-License-Identifier: GPL-3.0-or-later
//
// These 781 constants define the standard Polyglot Zobrist hash used for
// opening-book compatibility. The constants originate from the Polyglot /
// Fruit 2.1 project (GPL) by Fabien Letouzey and Tord Romstad, and are
// required as-is for Polyglot book format compatibility. See
// THIRD_PARTY_NOTICES.md for attribution and license notes.
#pragma once
#include "types.h"

namespace Veltrix {

constexpr int POLYGLOT_RANDOM_COUNT = 781;
const U64 POLYGLOT_RANDOM[POLYGLOT_RANDOM_COUNT] = {
